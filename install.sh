...
echo "1/10: get PHYSICS... (1/2) LMDZ.COMMON"
svn update -r $ver_phys -q LMDZ.COMMON
echo "2/10: get PHYSICS... (2/2) LMDZ.GENERIC"
svn update -r $ver_phys -q LMDZ.GENERIC

echo "3/10: get interface... (1/3) ICOSA_LMDZ"
svn update -r $ver_phys -q ICOSA_LMDZ
echo "4/10: get interface... (2/3) ARCH"
svn update -r $ver_phys -q ARCH
echo "5/10: get interface... (3/3) DOC"
svn update -r $ver_phys DOC

echo "6/10: get I/O libraries... (1/2) IOIPSL"
svn co -r $ver_xios -q http://forge.ipsl.jussieu.fr/ioserver/svn/XIOS/trunk XIOS
echo "7/10: get I/O libraries... (2/2) XIOS"
